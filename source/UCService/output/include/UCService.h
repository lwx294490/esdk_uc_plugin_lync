...
extern "C"
{
	...
	**/
	 ...
	 *该函数用于呼叫时转多人会议
	 *
	 *@param[in]	memList		成员列表
	 *@param[in]	memsize		结构体内存字节数
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	暂无
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_TransCallToConf(STConfMemList* pMemList,int memsize);
	...
	**/
	 ...
	 *该函数用于设置前传号码
	 *
	 *@param[in]	_type		扩展业务类型	
	 *@param[in]	_CallExData	号码，如果是取消业务，号码为空串	
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	登陆前先初始化
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_SetCallExService(int _type,const STCallExData* _CallExData);
	 ...
	 *该函数用于获取前传业务及号码
	 *
	 *@param[in]	_type		扩展业务类型，参考	
	 *@param[out]	_CallExData	号码，如果是取消业务，返回号码为空
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	登陆前先初始化
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_GetCallExService(int _type,STCallExData* _CallExData);
	 ...
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_BlindTransCall(int iMemberType,const char* pMember);
	 ...
	 *该函数用于设置呼叫转移事件回调函数
	 *
	 *@param[in]	crEventCallBack		呼叫转移事件回调函数指针
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	登陆后立即调用
	 *@par			无
	**/
	...
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_SetCallReservedEventCallBack(CallReservedEventCB crEventCallBack);
	 ...
	 *该函数用于呼叫企业通讯录
	 *
	 *@param[in]	 strSearchKey		查询关键字。为空时表示查询所有列表
	 *@param[in]	 _fromIndex			查询起始序列号。要求返回的数据
	 *@param[in]	 _toIndex			查询截止序列号。要求返回的数据,注意最多查询100个
	 *@param[out]	_pContactList		返回的数据
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	无
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_GetEntContactList(const char* strSearchKey, int _fromIndex,int _toIndex, STContactList* _pContactList);
	 ...
	 *
	 *@param[in]	_account		账户
	 *@param[in]	_IMContent		IM内容
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	无
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_SendIM(const char* _account,const char* _IMContent);
	 ...
	 *该函数用于设置IM回调方法
	 *
	 *@param[in]	IMRecvCallBack		接收到IM消息事件回调函数指针
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	登陆后立即调用
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_SetIMEventCallBack(IMRecvNotifyCB IMRecvCallBack);
	 ...
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_TransFile(const char* _account,const char* _FilePath,char _ConvID[STRING_LENGTH],char _TranID[STRING_LENGTH]);
	...
	**/
	 ...
	 *该函数用于设置文件接收回调方法
	 *
	 *@param[in]	FileTransNotifyCB		文件传输事件回调函数指针
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	登陆后立即调用
	 *@par			无
	**/
	ESDK_UCSERVICE_API int __UC_SDK_CALL UC_SDK_SetFileRecvEventCallBack(FileTransNotifyCB FileTransCallBack);
	 ...
	 *该函数用于设置呼叫转移事件回调方法
	 *
	 *@param[in]	CallTransCallBack		呼叫转移回调
	 *@return		0	成功
	 *@return		非0	失败（参考错误返回码）
	 *@attention	登陆后立即调用
	 *@par			无

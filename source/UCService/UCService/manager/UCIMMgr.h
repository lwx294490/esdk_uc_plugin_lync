...
public:
	...
	int AcceptFile(const std::string& _account,const std::string& _tranid,const std::string& _filesavepath);
	int RejectFile(const std::string& _account,const std::string& _filepath);
	int CancelFile(const std::string&_account,const std::string& _filepath);
